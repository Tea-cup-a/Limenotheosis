...
#### [Capabilities](../2.%20Glossary/Capabilities.md): (WIP)
...
Limenotheosis asks you to define a list of Strengths and Weaknesses using the keyword system (Traits): 
* For each strength you determine at character creation, design a weakness. Up to three in each (rewrite needed).
...
- What was your [Catalyst](../2.%20Glossary/Catalyst.md)? 
	- An obstacle you cannot overcome with your mortal strength.
- What was your spark?
	- The miraculous solution that's now bound to you.

Then, 
* Set your Humanity to 100 
* Set your Divinity to the appropriate Tier for play as determined at your table
