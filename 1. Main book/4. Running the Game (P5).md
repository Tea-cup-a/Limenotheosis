...
In a given session, units of time used range from **moments, act, 

In a prolonged game, the base measure of time is **chapter (session)**, then different lengths of story categorized into **tale (short quests of 3-4 sessions), saga (spanning 2 or more tales), legend (complete character story, regardless of how many tales or sagas).**
