...
---
### Time (WIP)
Time is tracked loosely in game to let the story and narrative take center frame. When it is needed, time can flow softly and slowly, even stop. Other times, years flashes by in seconds of real time. Depending on the miracles involved, any amount of time shenanigans can happen. 

In a given session, units of time used range from **moments, scenes, and act.**
- **Moments**: In a split second, a character may be called to act or react in the moment. Or, perhaps in a planned out sequence, it takes a moment to execute the required actions. This is what a moment account for, something that can be done in one swift motion, both in actionable behavior and thought. To change from one moment to another is to decide upon a different action or course of actions. 
- **Scenes**: Across many moments in a prolonged display, a character acts and make multiple moves to get closer to their goal in a scene. 

In a prolonged game, the base measure of time is **chapter**, then different lengths of story categorized into **tales or sagas.** 
